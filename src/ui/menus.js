...
export function optionsMenu(app, onClose) {
  ...
  return new MenuScreen(app, {
    ...
    items: [
      ...
      { label: 'Grafik-Engine', type: 'choice', get: () => s.engine, set: (v) => { s.engine = v; apply(); },
        options: [{ label: 'WebGL (Grafikkarte)', value: 'webgl' }, { label: 'Klassisch', value: 'classic' }],
        desc: 'WebGL: echtes Licht, weiche Schatten, Nebel. Klassisch: für schwache Geräte. Wirkt nach Neuladen (Cmd+R).' },
